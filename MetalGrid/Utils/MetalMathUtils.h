...
#define MTL_SIMD_OVERLOAD __attribute__((__overloadable__))
...
matrix_float3x3 MTL_SIMD_OVERLOAD matrix3x3_scale(float x, float y, float z);
...
quaternion_float MTL_SIMD_OVERLOAD quaternion(float radians, float x, float y, float z);

/// Constructs a unit-norm quaternion that represents rotation by the specified angle about the specified axis
quaternion_float MTL_SIMD_OVERLOAD quaternion(float radians, vector_float3 axis);
